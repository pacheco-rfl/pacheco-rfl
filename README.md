...
I completed a Web Development course at Instituto da Oportunidade Social (IOS) and continue expanding my knowledge through hands-on projects and continuous learning.

Currently, I am taking the **Spring Boot Expert: JPA, REST, JWT, OAuth2 with Docker and AWS** course, deepening my knowledge in modern Back-End development and scalable applications.
...
<p align="left">
  ...
  <img alt="Spring" width="45px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" />
...
###  JARVIS - Process Automation (RPA)

A project developed to automate operational tasks performed in corporate systems, reducing execution time and minimizing manual errors.
...
*  Automated login in web systems
...
My goal is to develop solutions that create real impact by applying software engineering best practices, automation, and software architecture principles while continuously growing as a technology professional.
